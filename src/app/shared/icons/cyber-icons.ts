// Cyber Icons - SVG definitions for MultiDesktopFlow
// All icons follow the same style: viewBox 24x24, stroke-based, currentColor
...
export const CYBER_ICONS = {
  ...
  // Inbox Empty
  inboxEmpty: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  // Cloud Download
  cloudDownload: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export type CyberIconName = keyof typeof CYBER_ICONS;
